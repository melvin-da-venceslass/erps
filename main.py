        ...
        if insertion == True:
            if obj.docType=="Invoice + DC" :
                ...
                if obj.dc_checkbox==True:
                    dc_writter(obj)
                    return {"file":obj.invoice_no,"data":obj,"url":"https://mviis-erps.herokuapp.com/get_document/"+obj.invoice_no+".pdf","url_dc":"https://mviis-erps.herokuapp.com/get_document/"+obj.delivery_note+".pdf",}
                else:
                    return {"file":obj.invoice_no,"data":obj,"url":"https://mviis-erps.herokuapp.com/get_document/"+obj.invoice_no+".pdf","url_dc":None,}
