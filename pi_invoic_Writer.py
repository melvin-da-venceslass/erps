...
pdf_template_file_name = 'PI_TEMP.pdf'
...
################
    ...
    pdf = content(pdf,invoice_params["address_bill"],panel_x,panel_y+25,w=220,h=10)
    ...
    pdf = title(pdf,invoice_params["p_order"],panel_x,panel_y+25,w=panel_w,h=10,f=10)
